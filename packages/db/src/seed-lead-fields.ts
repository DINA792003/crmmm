...
const STANDARD_LEAD_FIELDS: FieldSeed[] = [
  ...
  },
  {
    ...
    picklistValues: [
      ...
      { label: 'Sales', value: 'SALES', displayOrder: 5 },
      { label: 'Opportunity', value: 'OPPORTUNITY', displayOrder: 6 },
      { label: 'Quotation', value: 'QUOTATION', displayOrder: 7 },
      { label: 'Approval', value: 'APPROVAL', displayOrder: 8 },
      { label: 'Booking', value: 'BOOKING', displayOrder: 9 },
      { label: 'Duplicate', value: 'DUPLICATE', displayOrder: 10 },
      { label: 'Lost', value: 'LOST', displayOrder: 11 },
      { label: 'Booked', value: 'BOOKED', displayOrder: 12 },
    ],
  },
  {
