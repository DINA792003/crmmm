...
export const PROFILE_STATUS_ACCESS: Record<string, LeadStatus[]> = {
  ...
  Manager: Object.values(LeadStatus),
  Admin: Object.values(LeadStatus),
  'CRM Admin': Object.values(LeadStatus),
};
...
export const STATUS_TRANSITIONS: Record<string, { next: LeadStatus; profiles: string[] }[]> = {
  ...
  [LeadStatus.LOST]: [
    ...
    { next: LeadStatus.PROSPECT, profiles: ['Recovery', 'Admin', 'CRM Admin'] },
    { next: LeadStatus.SITE_VISIT_SCHEDULED, profiles: ['Recovery', 'Admin', 'CRM Admin'] },
    { next: LeadStatus.SITE_VISIT_HAPPENED, profiles: ['Recovery', 'Admin', 'CRM Admin'] },
    { next: LeadStatus.BOOKED, profiles: ['Recovery', 'Admin', 'CRM Admin'] },
  ],
};
